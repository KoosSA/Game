...
public class TextureLoader {
	...
	/**
	 * Only use this function when the texture is located in a different folder than the Texture {@link CommonFolders Commonfolder.Texture}.
	 * @param path - with the texture full name and extension included
	 * @return
	 */
	public static Texture2D createTextureFromPath(String path, String name) {
		Log.debug(TextureLoader.class, "Creating texture @ " + path);
